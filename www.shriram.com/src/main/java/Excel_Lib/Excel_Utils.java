...
public class Excel_Utils {
	...
	public static ArrayList<Object[]> getDataFromexcel() {
		...
		try {
			String s = "C:\\Users\\S2605\\GIT_HUB\\SFL_TESTING\\www.shriram.com\\Excel\\Book1.xlsx";
	...
	public static void writeinexcel(String value, int INDEX) throws Exception {
		File fis = new File("C:\\Users\\S2605\\GIT_HUB\\SFL_TESTING\\www.shriram.com\\Excel\\Book1.xlsx");
		FileInputStream excelloc = new FileInputStream(fis);
		@SuppressWarnings("resource")
		XSSFWorkbook wb = new XSSFWorkbook(excelloc);
		XSSFSheet s = wb.getSheetAt(0);
