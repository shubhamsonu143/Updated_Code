...
public class excel_Utility {
	...
	public static ArrayList<Object[]> getDataFromexcel() {
		...
		try {
			String s = "C:\\Users\\m1077\\GIT_HUB\\SFL_TESTING\\SFL_FD_Minor_Flow\\src\\main\\java\\Documents\\TestdataMinorFlow.xlsx";
...
//			String date = reader.getCellData("Sheet1", "date", rowNum);			
			...
			String guardianpan = reader.getCellData("Sheet1", "guardianpan", rowNum);
			String Guardianemail = reader.getCellData("Sheet1", "Guardianemail", rowNum);
			String GuardianDocumentNo = reader.getCellData("Sheet1", "GuardianDocumentNo", rowNum);
			String Guardianfrontimg = reader.getCellData("Sheet1", "Guardianfrontimg", rowNum);
			String GuardianBackimg = reader.getCellData("Sheet1", "GuardianBackimg", rowNum);
			String Gaurdianphoto = reader.getCellData("Sheet1", "Gaurdianphoto", rowNum);
			String Guardianaddress1 = reader.getCellData("Sheet1", "Guardianaddress1", rowNum);
			String Guardianaddress2 = reader.getCellData("Sheet1", "Guardianaddress2", rowNum);
			String GuardianPincode = reader.getCellData("Sheet1", "GuardianPincode", rowNum);
			...
			Object ob[] = { INDEX, mobile, pincode, otp_code,pan,year, month,email, guardianpan, Guardianemail,
					GuardianDocumentNo, Guardianfrontimg, GuardianBackimg, Gaurdianphoto, Guardianaddress1,
					Guardianaddress2, GuardianPincode, DocumentNo, frontimg, backimg, investorphoto, address1, address2,
					accNo, confirmacc, ifscode, accountType, accName, cheque, OccupationType, maritalstatus,
					fathername };
			myData.add(ob);
		}
		return myData;
	...
	public static void writeinexcel(String value, int INDEX) throws Exception {
		...
		File fis = new File("C:\\Users\\m1077\\GIT_HUB\\SFL_TESTING\\SFL_FD_Minor_Flow\\src\\main\\java\\Documents\\TestdataMinorFlow.xlsx");
